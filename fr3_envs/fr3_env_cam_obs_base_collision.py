...
from fr3_env_cam_obs_base import FR3CameraSim


class FR3CameraSimCollision(FR3CameraSim):
    def __init__(self, camera_config, enable_gui_camera_data, base_translation=[0,0,0], base_orientation_euler=[0,0,0],
                  obs_urdf="box.urdf", render_mode: Optional[str] = None, record_path=None, crude_type="ellipsoid"):
        super().__init__(camera_config, enable_gui_camera_data, base_translation, base_orientation_euler, obs_urdf,
