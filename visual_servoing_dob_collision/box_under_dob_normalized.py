...
def main():
    ...
    parser.add_argument('--exp_num', default=9, type=int, help="test case number")
    ...
    if test_settings["visualize_target_traj_from_last"] == 1:
        results_dir_keep = "{}/results_collision_dob/exp_{:03d}_w_cbf".format(str(Path(__file__).parent.parent), exp_num)
